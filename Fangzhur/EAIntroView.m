...
- (void)buildBackgroundImage {
    ...
    self.pageBgBack.contentMode = UIViewContentModeScaleAspectFill;
    ...
    self.pageBgFront.contentMode = UIViewContentModeScaleAspectFill;
...
//    if (*xIndex == SCREEN_WIDTH * 4) {
//        UIButton *finishButton = [UIButton buttonWithType:UIButtonTypeCustom];
//        finishButton.frame     = CGRectMake(110, SCREEN_HEIGHT - 120, SCREEN_WIDTH - 220, 35);
//        [finishButton setTitle:@"立即体验" forState:UIControlStateNormal];
//        [finishButton setBackgroundImage:[UIImage imageNamed:@"btn_xian"] forState:UIControlStateNormal];
//        [finishButton addTarget:self action:@selector(finishIntroduce) forControlEvents:UIControlEventTouchUpInside];
//        [pageView addSubview:finishButton];
//    }
